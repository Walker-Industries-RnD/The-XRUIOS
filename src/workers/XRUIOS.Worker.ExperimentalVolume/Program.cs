...
// XRUIOS ExperimentalVolume worker. Owns only its class's store; other programs reach it through the Manager
...
const string ServerName = "XRUIOS.Worker.ExperimentalVolume";
